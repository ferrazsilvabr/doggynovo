module.exports = async (bot) => { //faz algo qdo o bot liga
  ...
  const atividades = [
     ["Me Chamo Doggy ", "LISTENING"],
     ["Me Adicione Em Seu Servidor", "PLAYING"],
     ["Entre No Meu Discord De Suporte", "WATCHING"],
     ["Curta Meus Comandos", "WATCHING"]//bot adicionar quantos quiser :V
    ];
