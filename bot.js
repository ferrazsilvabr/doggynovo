...
bot.on("guildMemberAdd", async (member) => {
  ...
  let guild = bot.guilds.cache.get("745353181730439239");
  let channel = bot.channels.cache.get("745353181730439242");
  let emoji = member.guild.emojis.cache.find(emoji => emoji.name === 'cao');
  if(guild != member.guild) {
    return console.log(`Sai Daqui Mermao.`);
  } else {
    ...
    .setImage('https://31.media.tumblr.com/c4adc2577a659c81e546a660a94c0589/tumblr_nhinwe8JAy1rbrys3o1_500.gif')
    .setDescription(`${member.user}, bem vindo(a) ao servidor ${guild.name}! neste momento estamos com ${guild.guild.memberCount} membros.`)
